...
set SYNT_SCRIPT    "${ROOT}/sw/workbench/GENUS/scripts"
set SYNT_OUT       "${ROOT}/sw/workbench/GENUS/outputs"
set SYNT_REPORT    "${ROOT}/sw/workbench/GENUS/reports"
...
report timing -lint > $SYNT_REPORT/timing_lint_new.rpt
